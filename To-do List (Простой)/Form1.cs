namespace To_do_List__Простой_
{
    public partial class Form1 : Form
    {
        ...
        private void done1_Click(object sender, EventArgs e)
        {
            ...
            UpdateTimeDisplay(1);
            readLabel1.Text = "✅ Выполнено";
            readLabel1.ForeColor = Color.Green;
        }
        ...
        private void done2_Click(object sender, EventArgs e)
        {
            ...
            UpdateTimeDisplay(2);
            readLabel2.Text = "✅ Выполнено";
            readLabel2.ForeColor = Color.Green;
        }
        ...
        private void done3_Click(object sender, EventArgs e)
        {
            ...
            UpdateTimeDisplay(3);
            readLabel3.Text = "✅ Выполнено";
            readLabel3.ForeColor = Color.Green;
        }
        ...
        private void done4_Click(object sender, EventArgs e)
        {
            ...
            UpdateTimeDisplay(4);
            readLabel4.Text = "✅ Выполнено";
            readLabel4.ForeColor = Color.Green;
        }
